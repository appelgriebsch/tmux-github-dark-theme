...
set -g @plugin 'appelgriebsch/tmux-github-dark-theme'
...
$ git clone https://github.com/appelgriebsch/tmux-github-dark-theme /a/path/you/choose

Add this line to the bottom of `.tmux.conf`:

run-shell /a/path/you/choose tmux-github-dark-theme.tmux
...
### Widgets not working
   ...
   Make sure that you put the `set -g @plugin 'appelgriebsch/tmux-github-dark-theme'` before other scripts that alter the status line, or they won't be able to pickup the plugin's changes.
